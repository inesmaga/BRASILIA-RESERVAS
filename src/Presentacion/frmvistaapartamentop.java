 ...
 * @author inesm
 */
public class frmvistaapartamentop extends javax.swing.JFrame {

    /**
     * Creates new form frmvistaapartamento
     */
    public frmvistaapartamentop() {
        initComponents();
        mostrar("");
    ...
    private void tablalistadoMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablalistadoMousePressed
        ...
        if (evt.getClickCount()==2) {
            ...
            frmprorroga.txtidapartamento.setText(cod);
            frmprorroga.txtnumero.setText(valor);
              frmprorroga.txtprecb.setText(pb);
               frmprorroga.txtpreca.setText(pa);
            this.dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmvistaapartamentop.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmvistaapartamentop().setVisible(true);
            }
        });
    }
