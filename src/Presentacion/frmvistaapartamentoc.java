 ...
 * @author inesm
 */
public class frmvistaapartamentoc extends javax.swing.JFrame {

    /**
     * Creates new form frmvistaapartamento
     */
    public frmvistaapartamentoc() {
        initComponents();
        mostrar("");
    ...
    private void tablalistadoMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablalistadoMousePressed
        ...
        if (evt.getClickCount()==2) {
            ...
            frmconsumo.txtidapartamento.setText(cod);
            frmconsumo.txtnumero.setText(valor);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmvistaapartamentoc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmvistaapartamentoc().setVisible(true);
            }
        });
    }
