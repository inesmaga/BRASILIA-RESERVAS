 ...
 * @author inesm
 */
public class frmvistareservap extends javax.swing.JFrame {

    /**
     * Creates new form frmvistaapartamento
     */
    public frmvistareservap() {
        initComponents();
        mostrar("");
    ...
    private void initComponents() {
        ...
        listadoapartamentos.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED), "Posibles  Prórrogas", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 3, 16), new java.awt.Color(0, 153, 204))); // NOI18N
    ...
    private void tablalistadoMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablalistadoMousePressed
        ...
        if (evt.getClickCount()==2) {
            ...
            String tt,cod,cli,te,icli,nua,ida;
           
            
            cod=tablalistado.getValueAt(fila, 0).toString();
             ida=tablalistado.getValueAt(fila, 1).toString();
              nua=tablalistado.getValueAt(fila, 2).toString();
            icli=tablalistado.getValueAt(fila, 3).toString();
           cli=tablalistado.getValueAt(fila, 4).toString();
            te=tablalistado.getValueAt(fila, 9).toString();
            tt=tablalistado.getValueAt(fila, 6).toString();
                       
            
            frmprorroga.txtidreserva.setText(cod);
            frmprorroga.txtidapartamento.setText(ida);
            frmprorroga.txtnumero.setText(nua);
            frmprorroga.txtidcliente.setText(icli);
            frmprorroga.txtcliente.setText(cli);
             frmprorroga.txttemporada.setText(te);
             frmprorroga.txttipo_reserva.setText(tt);
             
              
            frmprorroga.dcfecha_iniprog.setDate(Date.valueOf(tablalistado.getValueAt(fila,7).toString()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmvistareservap.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmvistareservap().setVisible(true);
            }
        });
    }
