...
public class frmvistareserva extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        listadoapartamentos.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED), "Listado de Reservas", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 3, 16), new java.awt.Color(0, 153, 204))); // NOI18N
    ...
    private void tablalistadoMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablalistadoMousePressed
        ...
        if (evt.getClickCount()==2) {
            ...
            frmconsumo.txtidreserva.setText(cod);
            frmconsumo.dcfecha_ingreso.setDate(Date.valueOf(tablalistado.getValueAt(fila,4).toString()));
              frmconsumo.dcfecha_salida.setDate(Date.valueOf(tablalistado.getValueAt(fila, 5).toString()));
              this.dispose();
        }
