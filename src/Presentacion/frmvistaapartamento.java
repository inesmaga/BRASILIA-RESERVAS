 ...
 * @author inesm
 */
public class frmvistaapartamento extends javax.swing.JFrame {

    /**
     * Creates new form frmvistaapartamento
     */
    public frmvistaapartamento() {
        initComponents();
        mostrar("");
    ...
    private void tablalistadoMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablalistadoMousePressed
        ...
        if (evt.getClickCount() == 2) {
            ...
            pb = tablalistado.getValueAt(fila, 5).toString();
            pa = tablalistado.getValueAt(fila, 6).toString();
            esap = tablalistado.getValueAt(fila, 8).toString();
            fuo=(Date.valueOf(tablalistado.getValueAt(fila, 7).toString()));
           
            
            frmreserva.txtidapartamento.setText(cod);
            frmreserva.txtnumero.setText(valor);
            frmreserva.txtprecb.setText(pb);
            frmreserva.txtpreca.setText(pa);
            frmreserva.txtestadap.setText(esap);
            
            frmreserva.dcultiocup.setDate(fuo);
            if (esap.equals("Ofertable")){
              fApartamento func= new fApartamento();  
             
            frmreserva.dcfecha_ingreso.setDate( func.Sumdy(fuo,1));
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmvistaapartamento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmvistaapartamento().setVisible(true);
            }
        });
    }
